 ...
 * Modified version of ArcanistLintWorkflow.
 * Main modification : Send repositoryAPI and self to the lint engine.
 */
final class ArcanistCourseraLintWorkflow extends ArcanistWorkflow {
...
EOTEXT
  ...
  public function run() {
    ...
    // [Modification Start] Added by Coursera
    $engine->setWorkflow($this);
    $engine->setRepositoryAPI($this->getRepositoryAPI());
    // [Modification End] Added by Coursera
